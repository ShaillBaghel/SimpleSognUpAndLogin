...
var _require = require("../constants/messages"),
  TASK_CREATED_SUCCESSFULLY = _require.TASK_CREATED_SUCCESSFULLY,
  TASK_NOT_FOUND = _require.TASK_NOT_FOUND;
...
exports.getTasks = /*#__PURE__*/function () {
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _id = req.params.id; // const task = await Task.findOne({ _id: _id.toString(), owner: req.user._id });
          _context3.prev = 1;
          _context3.next = 4;
          return Task.findOne({
            _id: _id,
